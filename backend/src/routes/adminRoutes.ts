...
router.post('/papers', (req: Request, res: Response) => res.status(501).json({ message: 'Not implemented' }));
router.put('/papers/:id', (req: Request, res: Response) => res.status(501).json({ message: 'Not implemented' }));

router.post('/guides', (req: Request, res: Response) => res.status(501).json({ message: 'Not implemented' }));
router.put('/guides/:id', (req: Request, res: Response) => res.status(501).json({ message: 'Not implemented' }));
