...
const addLeaderboardScore = async (req, res) => {
...
const addPerformanceResult = async (req, res) => {
    const userId = req.user?.id;
...
module.exports = { getPapers, getGuides, getLeaderboard, addLeaderboardScore, getPerformance, addPerformanceResult };
