...
const CareerIcon = (props: React.ComponentProps<"svg">) => <CareerIconImported {...props} />;
...
const DashboardTile: React.FC<{ title: string; description: string; colorClass: string; path: string; icon: React.ReactNode; tourId?: string; }> = ({ title, description, colorClass, path, icon, tourId }) => (
