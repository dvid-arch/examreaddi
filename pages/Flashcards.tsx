        ...
        return (
            <Card className="flex flex-col items-center justify-center text-center p-6">
                ...
                <div className="flex gap-4">
                    <button onClick={handleRestart} className="font-semibold text-primary py-2 px-5 rounded-lg border-2 border-primary hover:bg-primary-light transition-colors duration-200">
                        Study Again
                    </button>
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="max-w-3xl mx-auto">
                <div 
                    onClick={handleFlip} 
                    className={`w-full aspect-video rounded-2xl p-4 flex items-center justify-center text-center shadow-lg transition-transform duration-500 cursor-pointer select-none ${isFlipped ? 'bg-primary-light [transform:rotateY(180deg)]' : 'bg-white'}`}
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <button 
                            ...
                            className="font-semibold text-primary py-2 px-5 rounded-lg border-2 border-primary hover:bg-primary-light transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div className="space-y-6">
             <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                    <button onClick={() => setReminderModalVisible(true)} className="flex items-center justify-center gap-2 font-semibold text-primary py-2 px-5 rounded-lg border-2 border-primary hover:bg-primary-light transition-colors duration-200 w-full sm:w-auto">
                        <BellIcon />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {decks.map((deck) => (
                    <div key={deck.id} onClick={() => setSelectedDeck(deck)} className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer flex flex-col">
